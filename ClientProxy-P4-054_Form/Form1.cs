...
namespace ClientProxy_P4_054_Form
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            Console.ReadLine();*/
            label1.Text = "1 + 2 = " + hasilTambah +  Environment.NewLine + "3 - 2 = " + hasilKurang + Environment.NewLine + "2 x 2 = " + hasilKali + Environment.NewLine + "2 / 2 = " + hasilBagi + "Hasil Koordinat " + jarak;
        }
    }
}
